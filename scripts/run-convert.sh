...
echo "This will create/update files in the src/content/blog directory..."
...
if [ $? -eq 0 ]; then
    ...
    file_count=$(find ./src/content/blog -name "*.md" | wc -l)
    echo "Created/updated $file_count markdown files in src/content/blog directory"
else
